...
<div class="content-container">
	...
	<form id="form-join" method="POST" action="/users">
		...
		<ul class="error-msg-group">
			...
			<li id="error-msg-id-pattern">아이디: 2~20자 숫자, 영문 대/소문자를 사용해 주세요. (특수기호, 공백 사용 불가)</li>
			...
			<li id="error-msg-name-pattern">닉네임: 2~20자 숫자, 한글, 영문 대/소문자를 사용해 주세요. (특수기호, 공백 사용 불가)</li>
		</ul>
